...
export const NavBar = () => {
  return (
    <nav className='container lg:static lg:top-3 hidden lg:flex flex-col lg:flex-row mx-auto max-w-screen-xl px-8 lg:px-4 py-2 lg:bg-background justify-end gap-6 items-center '>
      {/* <Link
        href='/'
